...
Page 65 of 161U18ISI5202-BIG DATA TECHNOLOGIES
...
public static class WhetherForcastReducer extends Reducer<Text, Text, Text,
Text> {
...
Float.parseFloat(f2)) {
result = new Text("Time: " + f2Time + " MinTemp: " + f2 + "\t" + "Time: " +
f1Time + " MaxTemp: " + f1);
}
else {
result = new Text("Time: " + f1Time + " MinTemp: " + f1 + "\t"+ "Time: " +
f2Time + " MaxTemp: " + f2);
}
String fileName = "";
...
Page 69 of 161U18ISI5202-BIG DATA TECHNOLOGIES
} else if (key.toString().substring(0,
3).equals("BAL")) {
...
Text.class,Text.class);
MultipleOutputs.addNamedOutput(job,bosOutputName,TextOutputFormat.clas
s, Text.class,Text.class);
MultipleOutputs.addNamedOutput(job,ausOutputName,TextOutputFormat.clas
s, Text.class,Text.class);
